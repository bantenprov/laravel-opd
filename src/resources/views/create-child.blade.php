      ...
      <div class="col-lg-8">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{route('opd.store.child')}}" method="post">
              ...
              <div class="form-group">
                <label for="root">Level Unit Kerja</label>
                <select id="root" name="root" class="form-control form-control-lg">
                  <option value='_none'>-Pilih Induk OPD-</option>
